...
module tb_blitter_system_pipe;
  ...
  blitter_top blt(
    ...
    // [PAL8 v1] CLUT read port: not exercised by this TB (comp_pipeline doesn't
    // drive it until Task 1.2); tie the address to a stable value.
    .clut_rd_addr(11'd0), .clut_rd_data(),
    .idle(bt_idle));
