-- Fixture: verbatim copy of Patched Tunics' real data/lib/bindings.lua,
-- reproducing the nested-table binding shape (`action = { buttons={...},
-- keys={...} }`) real quests actually use, as opposed to the flat
-- `action = "key"` shape the other fixtures in this directory use. Copied
-- from deploy/quests/patched_tunics/data/lib/bindings.lua (not in git).
local bindings = {}
