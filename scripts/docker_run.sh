...
FORWARD_ENV="${FORWARD_ENV:-SOLARUS_PATCH_ONLY SOLARUS_REF SOLARUS_BUILD_DIR SOLARUS_USE_LUAJIT SOLARUS_GPROF SOLARUS_CULL_MARGIN SOLARUS_DEPLOY_LIBS SOLARUS2_REF SOLARUS2_SHA SOLARUS2_SRC_DIR SOLARUS2_BUILD_DIR SOLARUS2_USE_LUAJIT SOLARUS2_STOCK SOLARUS2_SKIP_APPLY SOLARUS2_PATCH_ONLY SOLARUS2_LTO}"
