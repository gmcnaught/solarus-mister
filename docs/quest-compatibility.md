...
| `patched_tunics` | `syllan-games/patched-tunics.git` | `0.3` | 1.5 | 320×240 | RUNNABLE_WITH_KEYMAP | generated, 9 actions mapped | 0 |
| `zelda_olb_se` | `solarus-games/games/zelda-olb-se.git` | `148402831136` (commit SHA, no tags exist) | 1.5 | 320×240 | RUNNABLE_WITH_KEYMAP | generated, 3 actions mapped | 2 (`monsters`, `commands`) |
| `zelda_roth_se` | `solarus-games/games/zelda-roth-se.git` | `v1.2.1` | 1.6 | 320×240 | RUNNABLE_WITH_KEYMAP | generated, 3 actions mapped | 3 (`monsters`, `look`, `commands`) |
...
needed), and `dropped_actions` (private-binding actions that couldn't be reached for
lack of spare pad inputs).
